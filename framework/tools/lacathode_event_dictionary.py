tags = [
    ...
    # --- Lighter Jet (Jet 1) Features ---
    "j1_px",              # 4: X-component of the momentum for the lighter jet.
    "j1_py",              # 5: Y-component of the momentum for the lighter jet.
    "j1_pz",              # 6: Z-component of the momentum for the lighter jet.
    "j1_mass",            # 7: Invariant mass of the lighter jet (mj1).
    "j1_n_particles",     # 8: Multiplicity (number of constituents/particles) within the lighter jet.
    ...
    # --- Heavier Jet (Jet 2) Features ---
    "j2_px",              # 15: X-component of the momentum for the heavier jet.
    "j2_py",              # 16: Y-component of the momentum for the heavier jet.
    "j2_pz",              # 17: Z-component of the momentum for the heavier jet.
    "j2_mass",            # 18: Invariant mass of the heavier jet (mj2).
    "j2_n_particles",     # 19: Multiplicity (number of constituents/particles) within the heavier jet.
    "j2_P_T_lead",        # 20: Transverse momentum (pT) of the highest-momentum particle inside Jet 2.
    "j2_tau_1",           # 21: 1-subjettiness for the heavier jet.
    "j2_tau_2",           # 22: 2-subjettiness for the heavier jet.
    "j2_tau_3",           # 23: 3-subjettiness for the heavier jet.
    "j2_tau_4",           # 24: 4-subjettiness for the heavier jet.
    "j2_tau2_over_tau1",  # 25: N-subjettiness ratio (tau21) for the heavier jet.
